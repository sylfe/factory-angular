...
export class Formateur extends User {
  constructor(id?: number, nom?: string, prenom?: string, adresse?: string, email?: string, telephone?: string, motDePasse?: string,
              version?: number, droits?: PersonneDroit[], private _enseignements?: Enseignement[], private _indisponibilites?: Indisponibilite[]) {
